...
import { lastNDays, calcStreak, toDateKey, todayKey } from "../utils/dateHelpers.js";
...
export const weeklyReport = async (req, res) => {
    ...
    const useMsg = `Here is the user's habit data for the last 7 days (${ctx.days[0]} to ${ctx.days[6]}):\n\n${ctx.perHabit
        .map(
            (h) =>
        ...
        if (!suggestions.length) {
            suggestions = [
                ...
                },
                {
                    ...
                    category: "Learning",
                    icon: "📚",
                    reason: "Compoundes into significant knowledge over weeks.",
                },
                {
...
export const morningMotivation = async (req, res) => {
    try {
        ...
        const ctx = habits
          ...
          const userMsg =  `Today's habits and streaks:\n${ctx}\n\nDone today: ${done}/${total}. Write a short, motivating morning message to inspire them to complete their habits today.`
